 ...
 *
 * Copyright (c) 2015-2016, Paul Reioux. All rights reserved.
 * Author: ThanhPhat <thanhphat1299@gmail.com>
 *
...
#define STOCK_CPU_MAX_SPEED	2050000
#else
#define STOCK_CPU_MAX_SPEED	1710000
#endif
#endif
